		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form:form name="form" modelAttribute="petsitter" action="petsitterForm" method="post">
					...
					<div class="row">
						<div class="col-md-6 form-group">
 							<form:input path="petAddress" class="form-control form-control-lg" id="petAddress" /> 
						</div>
						<div class="col-md-6 form-group">
							<p class="p1"><a onClick="searchAddress()"><input type="button" class="btn" id="searchAddress" value="상세주소 검색하기" /></a></p>
						</div>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5c936ac6ac05d2af1f08e75243c2728e&libraries=services"></script>
