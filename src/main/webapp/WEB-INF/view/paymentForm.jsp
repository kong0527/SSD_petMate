						...
						<div class="mr-auto">
							<nav class="site-navigation position-relative text-right"
								...
								<ul
									...
									<li><a href="categories.html" class="nav-link text-left">Politics</a>
									</li>
									<li><a href="categories.html" class="nav-link text-left">Business</a>
									</li>
						...
						<form method="post">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="fname">제목</label> <input type="text"
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="eaddress">은행명</label> <input type="text"
										id="eaddress" class="form-control form-control-lg">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="eaddress">카드번호</label> <input type="text"
										id="eaddress" class="form-control form-control-lg">
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 form-group">
									<label for="message">CVC 번호</label>
