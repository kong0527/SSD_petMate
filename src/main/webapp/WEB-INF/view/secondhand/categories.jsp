			...
			<div class="col-lg-9">
				...
				<div class="post-entry-2 d-flex">
					<div class="thumbnail order-md-2"
						style="background-image: url('images/img_h_4.jpg')"></div>
					<div class="contents order-md-1 pl-0">
						<h2>
							<a href="${pageContext.request.contextPath}/secondhandDetail">secondhand detail</a>
						</h2>
						<p class="mb-3">secondhand test</p>
						<div class="post-meta">
