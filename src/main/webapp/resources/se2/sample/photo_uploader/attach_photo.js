    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/petMate/multiplePhotoUpload.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/petMate/photoUpload.do',	//샘플 URL입니다.
 	        sCallback : './sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
